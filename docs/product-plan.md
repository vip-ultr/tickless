...
24. **Glass recipe (approved):** cards `.glass` = blur(24px) sat(180%), light tint, inset top highlight. Navs + bottom sheet `.glass-strong` = blur(80px) sat(160%), oklch(0.16 0.02 240 / 0.88) tint. Non-blur fallbacks included.

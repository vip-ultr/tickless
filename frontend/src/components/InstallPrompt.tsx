...
export function InstallPrompt() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 flex justify-center px-3 pb-3 md:bottom-4 md:px-0">
      <div className="glass flex w-full max-w-md items-start gap-3 rounded-2xl border border-[var(--glass-border)] p-4 shadow-2xl">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            ...
            <button
              onClick={dismiss}
              className="flex items-center gap-2 rounded-xl px-4 py-2 text-sm tx-muted hover:tx"
            >
